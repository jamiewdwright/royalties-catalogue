  ...
  const onSubmit = async (data: AddHolderFormData) => {
    ...
    try {
      ...
      await dataService.holders.create({
        ...
        type: 'performer', // Default to performer type
        status: 'active', // Default to active status
        // r_number will be auto-generated by the service
      })
      ...
      <DialogContent className="sm:max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Personal & Contact Information</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold border-b pb-2">Payout Settings</h3>
